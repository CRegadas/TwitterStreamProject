 ...
 */
public interface TwitterStreamExtend extends OAuthSupport, TwitterBase {
 ...
 */
  /**
         ...
         */
        void addListener(StreamListenerExtend listener);
         ...
         */
        void removeListener(StreamListenerExtend listener);
         ...
         * @since Twitter4J 4.0.0
         */
        void replaceListener(StreamListenerExtend toBeRemoved, StreamListenerExtend toBeAdded);
